...
#+END_SRC
** Keybindings/window movement packages
*** Change undo to C-z
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** EXWM
Remove this section if you don't want to use Emacs as a full window manager. It also removes a number of window movement keybindings dependent on the super key not being used by another WM.
#+BEGIN_SRC emacs-lisp
  (use-package exwm
    :ensure t
    :config
    ...
    ;; Bindings for window movement/window resize
